...
export function PreOrderCatalogProducts({ title, description, linkTitle, link, products }: ICatalog) {
  ...
  return (
    <div className="max-w-[1100px] w-full mx-auto flex flex-col md:px-0 px-5 bg-[#F9F9F9]">
      <div className="flex items-center justify-between pt-16 mb-10">
        <h2 className="font-Heebo-24 text-[#000000]">Pre-Order</h2>
